...
#define System_Time_Priority           30
#define RelayControl_Task_Priority     28
#define EnergyMetering_Task_Priority   2
#define Terminal_Priority		       12
...
#define Terminal_StackSize				(256)	// TODO check this value
// #define Bootloader_Task_StackSize - see define below
#else
#define Terminal_StackSize		   		(8)
#define Timers_StackSize		   		(8)
#define System_Time_StackSize         	(8)
#define RelayControl_StackSize        	(8)
#define EnergyMetering_StackSize      	(8)
#define UNET_App_StackSize          	(8)
#define UNET_SensorsApp_StackSize   	(8)
// #define Bootloader_Task_StackSize - see define below
#endif
